...
import rs.raf.mealPlanner.presentation.view.recycler.viewholder.FilterViewHolder

class FilterAdapter(private val fragment: Fragment) : ListAdapter<Filter, FilterViewHolder>(FilterDiffCallback()), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FilterViewHolder {
        ...
        return FilterViewHolder(itemBinding, fragment)
    }
