...
class MealViewHolder(private val itemBinding: RecyclerItemMealBinding, private val fragment: Fragment) : RecyclerView.ViewHolder(itemBinding.root) {
    ...
    fun bind(meal: Meal) {
        ...
        itemBinding.RWItem.setOnClickListener{
            ...
            myFragment.selectMealInMainViewModel(meal)
            myFragment.slideToMealTab()
        }
    }
